...
let messages = {
  ...
  sevamenu: {
    question: {
      ...
      hi_IN:
        "आज हम आपकी सेवा कैसे कर सकते हैं? कृपया टाइप करें और अपने विकल्प के लिए नंबर भेजें 👇\n\n*1.* शिकायत दर्ज करें\n\n*2.* ट्रैक शिकायतें\n\n*3.* संपत्ति कर बिल का भुगतान करें\n\n*4.* भुगतान इतिहास देखें\n\n*5.* भाषा बदलें\n\n👉 किसी भी स्तर पर टाइप करें और मुख्य मेनू पर वापस जाने के लिए \'egov\' भेजें।",
      pa_IN:
        "ਅੱਜ ਅਸੀਂ ਤੁਹਾਡੀ ਸੇਵਾ ਕਿਵੇਂ ਕਰ ਸਕਦੇ ਹਾਂ? ਕਿਰਪਾ ਕਰਕੇ ਟਾਈਪ ਕਰੋ ਅਤੇ ਆਪਣੀ ਵਿਕਲਪ ਲਈ ਨੰਬਰ ਭੇਜੋ 👇\n\n*1.* ਫਾਈਲ ਸ਼ਿਕਾਇਤ\n\n*2.* ਟਰੈਕ ਸ਼ਿਕਾਇਤਾਂ\n\n*3.* ਜਾਇਦਾਦ ਟੈਕਸ ਬਿੱਲ ਦਾ ਭੁਗਤਾਨ ਕਰੋ\n\n*4.* ਭੁਗਤਾਨ ਦਾ ਇਤਿਹਾਸ ਵੇਖੋ\n\n*5.* ਭਾਸ਼ਾ ਬਦਲੋ\n\n👉 ਕਿਸੇ ਵੀ ਪੜਾਅ ਤੇ ਟਾਈਪ ਕਰੋ ਅਤੇ ਮੁੱਖ ਮੇਨੂ ਤੇ ਵਾਪਸ ਜਾਣ ਲਈ egov ਭੇਜੋ.",
    },
  },
  swachsevamenu: {
    question: {
...
let grammer = {
  ...
  menu: {
    question: [
      ...
      {
        intention: "locale",
        recognize: ["5", "language", "english", "hindi", "punjabi"],
      },
      // {
