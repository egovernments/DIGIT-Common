...
let messages = {
  ...
  searchBillInitiate: {
    question: {
      ...
      hi_IN: '\nकृपया अन्य बिल या शुल्क के लिए खोज और भुगतान करें जो आपके मोबाइल नंबर से लिंक नहीं हैं, टाइप करें \'1\' और भेजें। मुख्य मेनू पर वापस जाने के लिए \'egov\' टाइप करें और भेजें ।'
    },
    error:{
  ...
  endStatement: {
    ...
    hi_IN: "👉 मुख्य मेनू पर वापस जाने के लिए, टाइप करें और भेजें *egov*"
  },
  paymentDisclaimer: {
    en_IN: `👉 By clicking on the above link you confirm that your calculated property tax is correct or you can check your property details here ${config.egovServices.externalHost}citizen`,
    hi_IN: `👉 उपरोक्त लिंक पर क्लिक करके आप पुष्टि कर सकते हैं कि आपकी संपत्ति की गणना सही है। या आप यहां अपनी संपत्ति का विवरण देख सकते हैं ${config.egovServices.externalHost}citizen`,
    pa_IN: `👉 ਉਪਰੋਕਤ ਲਿੰਕ ਤੇ ਕਲਿਕ ਕਰਕੇ ਤੁਸੀਂ ਪੁਸ਼ਟੀ ਕਰ ਸਕਦੇ ਹੋ ਕਿ ਤੁਹਾਡਾ ਗਣਨਾ ਕੀਤਾ ਗਿਆ ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ ਸਹੀ ਹੈ ਜਾਂ ਤੁਸੀਂ ਆਪਣੀ ਸੰਪਤੀ ਦੇ ਵੇਰਵੇ ਇੱਥੇ ਵੇਖ ਸਕਦੇ ਹੋ ${config.egovServices.externalHost}citizen`
  }
}
let grammer = {
  confirmation: {
