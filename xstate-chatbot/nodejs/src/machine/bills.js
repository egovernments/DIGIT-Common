...
let messages = {
  ...
  paymentDisclaimer: {
    en_IN: '👉 By clicking on the above link you confirm that your calculated property tax is correct or you can check your property details here https://egov.lgpunjab.gov.in/citizen',
    hi_IN: '👉 उपरोक्त लिंक पर क्लिक करके आप पुष्टि कर सकते हैं कि आपकी संपत्ति की गणना सही है। या आप यहां अपनी संपत्ति का विवरण देख सकते हैं https://egov.lgpunjab.gov.in/citizen',
    pa_IN: '👉 ਉਪਰੋਕਤ ਲਿੰਕ ਤੇ ਕਲਿਕ ਕਰਕੇ ਤੁਸੀਂ ਪੁਸ਼ਟੀ ਕਰ ਸਕਦੇ ਹੋ ਕਿ ਤੁਹਾਡਾ ਗਣਨਾ ਕੀਤਾ ਗਿਆ ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ ਸਹੀ ਹੈ ਜਾਂ ਤੁਸੀਂ ਆਪਣੀ ਸੰਪਤੀ ਦੇ ਵੇਰਵੇ ਇੱਥੇ ਵੇਖ ਸਕਦੇ ਹੋ https://egov.lgpunjab.gov.in/citizen'
  }
}
let grammer = {
  confirmation: {
