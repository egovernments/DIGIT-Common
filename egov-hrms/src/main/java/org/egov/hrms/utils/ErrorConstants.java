...
public class ErrorConstants {
	...
	public static final String HRMS_INVALID_REACT_REQUEST_CODE = "ERR_HRMS_INVALID_REACT_REQUEST";
	public static final String HRMS_INVALID_REACT_REQUEST_MSG = "Employee cannot be reactivated as there are no deactivation records.";
