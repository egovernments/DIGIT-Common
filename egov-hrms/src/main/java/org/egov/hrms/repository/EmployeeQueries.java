...
public class EmployeeQueries {
	...
	public static final String HRMS_GET_UNASSIGNED_EMPLOYEES = "SELECT employee.uuid from {schema}.eg_hrms_employee employee LEFT JOIN {schema}.eg_hrms_assignment assignment ON employee.uuid = assignment.employeeid where assignment.employeeid is null";
}
